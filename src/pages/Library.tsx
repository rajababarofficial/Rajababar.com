...
import Books from '@/src/components/Books'; // Your component that reads CSV
    ...
    <div className="pt-24 pb-20 bg-brand-bg min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 space-y-6">
        ...
        <motion.div
          ...
          className="p-4 bg-brand-surface/20 border border-brand-border rounded-xl text-center text-sm text-brand-secondary"
        >
          {isSindhi
        ...
        <div className="mt-12 p-6 bg-brand-surface/30 border border-brand-border rounded-[2rem] flex flex-col md:flex-row items-center gap-6 max-w-4xl mx-auto">
          ...
          <div>
            <h4 className="font-bold text-brand-primary mb-1">{isSindhi ? "قانوني دستبرداري" : "Legal Disclaimer"}</h4>
